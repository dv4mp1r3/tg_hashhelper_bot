 ...
 * dvp.tg.bot.JIniFile stores and retrieves application-specific information and settings from INI files.
 * <br><br>
 * dvp.tg.bot.JIniFile enables handling the storage and retrieval of application-specific information
 ...
 * <br><br>
 * &lt;keyname&gt;=&lt;value&gt;<br>
 * A FileName is passed to the dvp.tg.bot.JIniFile constructor and identifies the INI file that the object accesses.</p>
...
public class JIniFile extends ArrayList {
    ...
    /**
     * Constructor dvp.tg.bot.JIniFile
     *
     * Creates a dvp.tg.bot.JIniFile object for an application. Create assigns the FileName parameter
